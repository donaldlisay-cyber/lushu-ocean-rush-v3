...
let shield = false, magnetTimer = 0, doubleTimer = 0;
...
function animate() {
  ...
  score += worldSpeed * dt * 0.4 * (doubleTimer > 0 ? 2 : 1);
  ...
  for (let i = activePowerups.length - 1; i >= 0; i--) {
    ...
    p.obj.position.z += worldSpeed * dt;
...
function startGame() {
  ...
  shield = false; magnetTimer = 0; doubleTimer = 0;
  shieldBubble.visible = false;
